  ...
  return (
    <div className="mx-4 flex flex-col rounded-lg bg-white px-4 py-5 text-center gap-y-6">
      ...
      <div className="flex flex-col text-center gap-y-2">
        ...
        />
        <span>
          Type <strong>{currentTodoItem?.todo.title}</strong> to delete.
        </span>
      </div>
      <div className="flex flex-row gap-x-4 justify-end">
        <button
          aria-label="delete-dialog-cancel-button"
        ...
        <button
          aria-label="delete-dialog-submit-button"
          className={`text-base rounded-md py-3 px-4 w-fit font-bold self-center ${
            confirmationText !== currentTodoItem?.todo.title
